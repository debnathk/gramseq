#!/bin/bash
#SBATCH --job-name=bindingdb_transform_labels
#SBATCH --output ./slurm_logs/output_bindingdb_transform_labels.log
#SBATCH --error ./slurm_logs/error_bindingdb_transform_labels.log
