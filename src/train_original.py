...
if args.dataset == 'bindingdb':
    print('Preprocess bindingdb dataset...')
    ...
    print('Preprocess davis dataset...')
    X_smiles, X_targets, y = dataset.load_process_DAVIS()
    print(f'No of unique drugs: {len(set(X_smiles))}')
    print(f'No of unique proteins: {len(set(X_targets))}')
    print(f'Total interactions: {len(y)}')

elif args.dataset == 'kiba':
    print('Preprocess kiba dataset...')
    X_smiles, X_targets, y = dataset.load_process_KIBA()
    print(f'No of unique drugs: {len(set(X_smiles))}')
    print(f'No of unique proteins: {len(set(X_targets))}')
    print(f'Total interactions: {len(y)}')
...
def main(): 
    ...
    for fold in range(args.folds):
        ...
        if args.rnaseq:
            checkpoint = ModelCheckpoint(WEIGHTPATH + f'bs{args.bs}_ep{args.epochs}_rnaseq_{args.dataset}_original_{args.protenc}_fold{fold}.hdf5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
            ...
            plt.ylabel('Loss')
            plt.legend()
            plt.savefig(PLOTSTPATH + f"loss_bs{args.bs}_ep{args.epochs}_rnaseq_{args.dataset}_original_{args.protenc}_fold{fold}.png")
            plt.close()
            ...
            plt.ylabel('MAE')
            plt.legend()
            plt.savefig(PLOTSTPATH + f"mae_bs{args.bs}_ep{args.epochs}_rnaseq_{args.dataset}_original_{args.protenc}_fold{fold}.png")
            plt.close()

        else:
            checkpoint = ModelCheckpoint(WEIGHTPATH + f'bs{args.bs}_ep{args.epochs}_{args.dataset}_original_{args.protenc}_fold{fold}.hdf5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
            ...
            plt.ylabel('Loss')
            plt.legend()
            plt.savefig(PLOTSTPATH + f"loss_bs{args.bs}_ep{args.epochs}_{args.dataset}_original_{args.protenc}_fold{fold}.png")
            plt.close()
            ...
            plt.ylabel('MAE')
            plt.legend()
            plt.savefig(PLOTSTPATH + f"mae_bs{args.bs}_ep{args.epochs}_{args.dataset}_original_{args.protenc}_fold{fold}.png")
            plt.close()
        ...
        if args.rnaseq:
            ...
            WEIGHTPATH = PATH + 'model_weights/'
            model.load_weights(WEIGHTPATH + f'bs{args.bs}_ep{args.epochs}_rnaseq_{args.dataset}_original_{args.protenc}_fold{fold}.hdf5')
            ...
            with open(TABLESPATH + f'bs{args.bs}_ep{args.epochs}_rnaseq_{args.dataset}_original_{args.protenc}_fold{fold}.txt', 'w') as f:
            ...
            plt.savefig(PLOTSTPATH + f"avsp_bs{args.bs}_ep{args.epochs}_rnaseq_{args.dataset}_original_{args.protenc}_fold{fold}.png")
            plt.close()
            ...
            print('----LOAD PRETRAINED MODEL----')
            WEIGHTPATH = PATH + 'model_weights/'
            model.load_weights(WEIGHTPATH + f'bs{args.bs}_ep{args.epochs}_{args.dataset}_original_{args.protenc}_fold{fold}.hdf5')
            print('----PRETRAINED MODEL LOADED----')
            print('----START TESTING----')
            ...
            TABLESPATH = PATH + 'results/tables/'
            os.makedirs(TABLESPATH, exist_ok=True)
            with open(TABLESPATH + f'bs{args.bs}_ep{args.epochs}_{args.dataset}_original_{args.protenc}_fold{fold}.txt', 'w') as f:
                f.write(f'{test_mse_loss},{test_pearson_corr},{test_c_index}')
            ...
            plt.ylabel('Predicted')
            plt.title('Actual vs Predicted')
            plt.savefig(PLOTSTPATH + f"avsp_bs{args.bs}_ep{args.epochs}_{args.dataset}_original_{args.protenc}_fold{fold}.png")
            plt.close()
