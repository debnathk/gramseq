#!/bin/bash
#SBATCH --job-name=bindingdb_vectorize_proteins
#SBATCH --output ./slurm_logs/output_bindingdb_vectorize_proteins.log
#SBATCH --error ./slurm_logs/error_bindingdb_vectorize_proteins.log
